print("姓名:程越,学号:18010102")
true = input("是否结合文件使用通讯录(y/n):")
if true =="y":
    file_1 = open("../python/StudyCode/2020年4月29日/addresses.txt","w+")
    for i in file_1:
        list_line = i.split()
    person_info = []
    print("=" * 20)
        ...
        if fun_num == '1':
            ...
            if per_name.strip() == '' or phone_num.strip() == ''or per_email.strip() == '' or per_address.strip() == '':
                ...
                for i in person_info:
                    for j in range(4):
                        print(i[dict_keys[j]],file = "../python/StudyCode/2020年4月29日/addresses.txt",end='')
                        file_1.close()
        elif fun_num == '2':
